...
const Hero = () => {
  ...
  return (
    <section className="w-full overflow-hidden flex flex-col items-center justify-center bg-[hsl(var(--background))] px-6 py-16 sm:py-24">
      <div className="w-full max-w-3xl mx-auto text-center">
        ...
        {/* Testimonial element replacing feature cards */}
        <div className="w-full max-w-2xl mx-auto py-8 opacity-90 fade-in">
